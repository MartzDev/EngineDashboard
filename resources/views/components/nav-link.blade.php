...
@php
    $classes =
        $active ?? false
            ...
            : 'flex items-center p-2 text-gray-900 transition duration-200 ease-in-out transform rounded-lg hover:bg-gray-100 hover:text-dark-900 hover:scale-95 dark:text-white dark:hover:bg-gray-700 group';
@endphp
