...
<aside id="logo-sidebar"
    class="fixed top-0 left-0 z-40 w-64 h-full bg-white transition-transform -translate-x-full bg-inherit sm:translate-x-0"
    aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto dark:bg-gray-800">

        {{-- <div class="flex items-center space-x-4 mb-5">
                <div class="relative">
                    <img class="w-10 h-10 rounded-full" src="{{ asset('storage/profile-picture-5.jpg') }}"
                        alt="">
                    <span
        ...
        <div class="flex items-center space-x-4 mb-5">
            <img class="w-20 h-20 rounded-full transition duration-200 ease-in-out transform hover:scale-95"
                src="{{ asset('storage/images/profile/tg.jpg') }}" alt="Large avatar">
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <x-nav-link :href="route('profile.edit')" :active="request()->routeIs('profile.edit')">
                    ...
                    <span class="ml-3">{{ Str::title(__('Profile')) }}</span>
                </x-nav-link>
            </li>
            ...
            <li>
                <x-nav-link :href="route('chirps.index')" :active="request()->routeIs('chirps.index')">
                    ...
                    <span class="ml-3">{{ Str::title(__('Chirp')) }}</span>
                </x-nav-link>
            </li>
            ...
            <li>
                <x-nav-link :href="route('contactos.index')" :active="request()->routeIs('contactos.index')">
                    ...
                    <span class="ml-3">{{ Str::title(__('contactos')) }}</span>
                </x-nav-link>
            </li>
            ...
            <li>
                <a href="#"
                    ...
                    <span class="flex-1 ml-3 whitespace-nowrap">{{ Str::title(__('productos')) }}</span>
                </a>
            </li>
